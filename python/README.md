...
This repository contains the code to generate Python according to [Rune](https://github.com/finos/rune-dsl) specifications.  
...
The Python package supports CDM version XXX and requires Python version 3.10+ and Pydantic ">=2.6.1+,<2.10"
